...
// Fonction du contrôleur CtrlAjouterDetailsSoiree.php : traiter la demande de création d'une nouvelle soirée
// Ecrit le 27/05/2021 par de Bailliencourt Baptiste
...
if (! isset ($_POST ["btnAjouter"])) {
    ...
    include_once ($cheminDesVues . 'VueAjouterUneSoiree.php');
}
else {
