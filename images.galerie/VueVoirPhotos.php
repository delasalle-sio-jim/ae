...
<body>
	<div id="page">
		<div id="content">
			<h3 style= "margin-left:12px;" id="haut"><i>Galerie photo des anciens élèves :</i></h3>
			...
			<div id="works">
				...
				<?php } ?>
				<a href = "#haut" style="position: bottom right" ><img src = "images.galerie/haut.jpg"></img> </a>	
  			</div><!-- #works -->
		</div>
	</div>
