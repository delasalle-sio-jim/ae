...
// Fonction de la vue vues.jquery/VueCreerCompteEleve.php : afficher la vue de modification d'un groupe par un administrateur
// Ecrit le 03/06/2021
...
<html>
	...
	<body>
		...
		<form name="form1" id="form1" action="index.php?action=ModifierGroupe" method="post">
				<p>
					<label for="listeGroupes">Le groupe à modifier :</label>
				...
				<p>
					<input type="submit" value="Modifier" name="btnEnvoyer" id="btnEnvoyer" />
				</p>
			</form>
						</div>
